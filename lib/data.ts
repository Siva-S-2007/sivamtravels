...
export const packages: Package[] = [
  {
    id: '1-day',
    title: {
      en: 'Navagraha One Day Tour Package',
      ta: 'நவகிரக ஒரு நாள் சுற்றுலாத் தொகுப்பு',
    },
    duration: { en: '1 Day', ta: '1 நாள்' },
    tagline: {
      en: 'Visit all 9 Navagraha temples in one day with a comfortable AC vehicle and experienced local driver.',
      ta: 'வசதியான ஏசி (AC) வாகனம் மற்றும் அனுபவம் வாய்ந்த உள்ளூர் ஓட்டுநருடன், ஒரே நாளில் 9 நவக்கிரகக் கோயில்களுக்கும் சென்று வாருங்கள்.',
    },
    overview: {
  ...
  },
  {
    id: '2-day',
    title: {
      en: 'Navagraha Two Day Tour Package',
      ta: 'நவகிரக இரண்டு நாள் சுற்றுலாத் தொகுப்பு'
    },
    duration: { en: '2 Days · 1 Night', ta: '2 நாட்கள் · 1 இரவு' },
    tagline: {
      en: 'Experience a relaxed pilgrimage with ample time for darshan, poojas, and nearby sacred temples.',
      ta: 'தரிசனம், பூஜைகள் மற்றும் அருகிலுள்ள புனிதத் தலங்களை வழிபடப் போதுமான அவகாசத்துடன் கூடிய, நிம்மதியான ஒரு புனிதப் பயணத்தை மேற்கொள்ளுங்கள்.',
    },
    overview: {
  ...
  },
  {
    id: '3-day',
    title: {
      en: 'Navagraha Three Day Tour Package',
      ta: 'நவகிரக மூன்று நாள் சுற்றுலாத் தொகுப்பு',
    },
    duration: { en: '3 Days · 2 Nights', ta: '3 நாட்கள் · 2 இரவுகள்' },
    tagline: {
      en: 'A complete spiritual journey covering all Navagraha temples and nearby heritage temples around Kumbakonam.',
      ta: 'கும்பகோணத்தைச் சுற்றியுள்ள அனைத்து நவக்கிரகக் கோயில்கள் மற்றும் அருகிலுள்ள பாரம்பரியக் கோயில்களை உள்ளடக்கிய ஒரு முழுமையான ஆன்மீகப் பயணம்.',
    },
    overview: {
  ...
  },
  {
    id: 'group-tour',
    title: {
      en: 'Navagraha Group Tour Package',
      ta: 'நவக்கிரகக் குழுச் சுற்றுலாத் தொகுப்பு',
    },
    duration: { en: '1 Day', ta: '1 நாள்' },
    tagline: {
      en: 'Travel with fellow devotees in an affordable shared pilgrimage covering the Navagraha temples.',
      ta: 'நவக்கிரகத் தலங்களை உள்ளடக்கிய, கட்டணம் குறைவான கூட்டுத் தீர்த்தயாத்திரையில் சக பக்தர்களுடன் இணைந்து பயணம் செய்யுங்கள்.',
    },
    overview: {
