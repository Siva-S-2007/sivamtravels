...
export const translations: Record<TranslationKey, Record<Lang, string>> = {
  ...
  'hero.eyebrow': { en: 'SACRED JOURNEYS · SOUTH INDIA', ta: 'புனித யாத்திரை · தென்னிந்தியா' },
  'hero.title1': { en: 'Walk the path of the', ta: 'ஒன்பது வான் கோயில்களின்' },
  'hero.title2': { en: 'Nine Celestial Temples', ta: 'புனித பாதையில் பயணிக்க' },
  'hero.subtitle': {
    en: 'Curated pilgrimages to the Navagraha temples — serene, soulful, and crafted with the devotion of a thousand years of tradition.',
    ta: 'நவகிரக கோயில்களுக்கான தேர்வு யாத்திரைகள் — அமைதியான, ஆன்மீக, ஆயிரம் ஆண்டு பாரம்பரிய பக்தியுடன் வடிவமைக்கப்பட்டது.',
  },
