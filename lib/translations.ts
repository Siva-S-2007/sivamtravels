...
export const translations: Record<TranslationKey, Record<Lang, string>> = {
  ...
  'hero.title2': { en: 'Navagraha Divine Journey', ta: 'நவக்கிரகப்   பயணத்தைத் தொடங்குங்கள்' },
  'hero.subtitle': {
    en: 'Best Navagraha Tour Packages from Kumbakonam',
  ...
  'faq.eyebrow': { en: 'Frequently Asked Questions', ta: 'அடிக்கடி கேட்கப்படும் கேள்விகள்' },
  'faq.title': {
    en: 'Everything You Need to Know<br>About Our Navagraha Tour Packages',
    ta: 'எங்கள் நவகிரக சுற்றுலா தொகுப்புகள் பற்றி<br>நீங்கள் தெரிந்து கொள்ள வேண்டிய அனைத்தும்',
  },
  'faq.subtitle': {
    en: 'Get answers to the most common questions about our Navagraha Tour Packages, temple visits, accommodation, vehicle options, and booking process.',
    ta: 'எங்கள் நவகிரக சுற்றுலா தொகுப்புகள், கோயில் సందర్శనలు, தங்குமிடம், வாகன விருப்பங்கள் மற்றும் முன்பதிவு செயல்முறை பற்றிய பொதுவான கேள்விகளுக்கான பதில்களைப் பெறுங்கள்.',
  },
