...
export const navagrahaModalData: Record<string, ModalData> = {
  surya: {
    id: 'surya',
    bannerImage: asset('/deities/suryan.jpg'),
    overview: {
  ...
  chandra: {
    id: 'chandra',
    bannerImage: asset('/gallery/chandrangallery.png'),
    overview: {
  ...
  angaraka: {
    id: 'angaraka',
    bannerImage: asset('/deities/sevvai.jpg'),
    overview: {
  ...
  budha: {
    id: 'budha',
    bannerImage: asset('/deities/budhan.jpg'),
    overview: {
  ...
  guru: {
    id: 'guru',
    bannerImage: asset('/gallery/gurugallery.png'),
    overview: {
  ...
  sukra: {
    id: 'sukra',
    bannerImage: asset('/deities/sukran.jpg'),
    overview: {
  ...
  shani: {
    id: 'shani',
    bannerImage: asset('/deities/shani.jpg'),
    overview: {
  ...
  rahu: {
    id: 'rahu',
    bannerImage: asset('/deities/rahu.jpg'),
    overview: {
  ...
  ketu: {
    id: 'ketu',
    bannerImage: asset('/deities/kethu.jpg'),
    overview: {
