...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative flex h-screen min-h-[640px] items-center justify-center overflow-hidden">
      ...
      <div className={`relative z-10 mx-auto px-6 text-center ${isTamil ? 'max-w-4xl' : 'max-w-[1200px]'}`}>
        <motion.h1
        ...
        <motion.h2
          ...
          className={`mt-8 font-body font-medium text-white text-center ${
        ...
        <motion.p
          ...
          className={`mx-auto mt-[18px] font-body leading-[1.7] text-white/90 text-center ${
            isTamil ? 'max-w-2xl text-base sm:text-lg' : 'text-lg sm:text-[21px]'
          }`}
        >
          {t('hero.description')}
        </motion.p>
