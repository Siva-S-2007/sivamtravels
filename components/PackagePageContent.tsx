...
import { Clock, ArrowRight, ArrowLeft, Phone, Check, Car, Star, BedDouble, Send, User, CalendarDays, Users, Baby, FileText, Package as PackageIcon, MapPin, ExternalLink } from 'lucide-react';
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-maroon">
                    ...
                    <th className="hidden px-5 py-4 text-left font-title text-base tracking-wide text-gold sm:table-cell">
                      {lang === 'en' ? 'Coverage' : 'உள்ளடக்கம்'}
                    </th>
                    <th className="hidden px-5 py-4 text-left font-title text-base tracking-wide text-gold lg:table-cell">
                ...
                <tbody>
                  {pkg.vehiclePricing.map((v, i) => (
                    <tr key={i} className="border-t border-gold/10 transition-colors hover:bg-gold/5">
                      ...
                      <td className="hidden px-5 py-4 font-body text-base text-charcoal/70 sm:table-cell">{v.coverage}</td>
                      <td className="hidden px-5 py-4 font-body text-base text-charcoal/70 lg:table-cell">{v.extraKm}</td>
                      <td className="hidden px-5 py-4 font-body text-base text-charcoal/70 lg:table-cell">{v.extraHr}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
